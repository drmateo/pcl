...
template class pcl::rec_3d_framework::GlobalNNPipeline<Metrics::HistogramsectionUnionDistance, pcl::PointXYZ, pcl::ESFSignature640>;
template class pcl::rec_3d_framework::GlobalNNPipeline<Metrics::HistogramsectionUnionDistance, pcl::PointXYZ, pcl::Histogram<352> >;
